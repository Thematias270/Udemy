...
# icono no se por que busca afuera de la carpeta,asi que para mejor practica
# usar la direccion completa
...
# varible puntaje
puntaje = 0
fuente_como_bytes = pygame.font.Font('freesansbold.ttf', 32)
